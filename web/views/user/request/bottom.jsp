   ...
   <div class="outer">
      ...
      <div class="inner">
         <table>
            ...
            <tr>
            <td class="fontGroup1">&nbsp;&nbsp;장판의 두께를 선택해주세요.</td>
            </tr>
            <tr>
               <td>
                  <button class="btn1">1.8mm</button>
                  <button class="btn1">2.0mm</button>
                  <button class="btn1">2.2mm</button>
                  <button class="btn1">4.5mm</button>
                  <button class="btn1">6.0mm</button>
               </td>
            </tr>
            <tr class="space">
            </tr>
            ...
            <tr>
               <td>
                  ...
                  <button class="btn1">거실 안함</button>
               </td>
            <tr class="space">
            </tr>
            <tr>
