...
<body>
	<div class="outer">
		...
		<div class="inner">
			<table>
				<tr>
					<td class="title1">거래를 취소하시겠습니까?</td>
				</tr>
				<tr>
					<td class="title1">거래취소시 취소사유를 입력해야 합니다.<br> 관리자는 유의해주시기 바랍니다.</td>
				</tr>
			</table>
		<div class="cancelNote">
			...
			<table>
				<tr>
					<td><button class="btn1" onclick="complete();">거래취소</button></td>
				</tr>
				<tr>
	...
	<script>
		...
		if($("textArea").val() != "") {
			...
			$.ajax({
				...
				location.replace("${ applicationScope.contextPath }/views/admin/pages/adminReqCancelPopup2.jsp");
			} else {
